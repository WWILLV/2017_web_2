(function(q, ha) {
    "object" === typeof module && "object" === typeof module.exports ? module.exports = q.document ? ha(q, !0) : function(q) {
        if (!q.document)
            throw Error("jQuery requires a window with a document");
        return ha(q)
    }
    : ha(q)
})("undefined" !== typeof window ? window : this, function(q, ha) {
    function Fa(a) {
    ...
    function bc(a) {
        var b = ab[a] = {};
        d.each(a.match(N) || [], function(a, d) {
            b[d] = !0
        });
        return b
    }
    function bb() {
        n.addEventListener ? (n.removeEventListener("DOMContentLoaded", S, !1),
        q.removeEventListener("load", S, !1)) : (n.detachEvent("onreadystatechange", S),
        q.detachEvent("onload", S))
    }
    function S() {
        if (n.addEventListener || "load" === event.type || "complete" === n.readyState)
            bb(),
            d.ready()
    }
    function cb(a, b, c) {
        if (void 0 === c && 1 === a.nodeType)
            if (c = "data-" + b.replace(cc, "-$1").toLowerCase(),
            c = a.getAttribute(c),
            "string" === typeof c) {
                try {
                    c = "true" === c ? !0 : "false" === c ? !1 : "null" === c ? null : +c + "" === c ? +c : dc.test(c) ? d.parseJSON(c) : c
                } catch (e) {}
                d.data(a, b, c)
            } else
                c = void 0;
    ...
    function eb(a, b, c) {
        if (d.acceptData(a)) {
            var e, f, g = a.nodeType, h = g ? d.cache : a, k = g ? a[d.expando] : d.expando;
            if (h[k]) {
                if (b && (e = c ? h[k] : h[k].data)) {
                    d.isArray(b) ? b = b.concat(d.map(b, d.camelCase)) : b in e ? b = [b] : (b = d.camelCase(b),
                    b = b in e ? [b] : b.split(" "));
                    for (f = b.length; f--; )
                        delete e[b[f]];
                    if (c ? !Ha(e) : !d.isEmptyObject(e))
                        return
                }
                if (!c && (delete h[k].data,
                !Ha(h[k])))
                    return;
    ...
    function y(a, b) {
        ...
        if (!g)
            ...
            c = a.childNodes || a; null != (e = c[f]); f++)
                !b || d.nodeName(e, b) ? g.push(e) : d.merge(g, y(e, b));
    ...
    function qa(a) {
        var b = n
          , c = nb[a];
        c || (c = mb(a, b),
        "none" !== c && c || (ia = (ia || d("<iframe frameborder='0' width='0' height='0'/>")).appendTo(b.documentElement),
    ...
    function pb(a, b) {
        if (b in a)
            return b;
        for (var c = b.charAt(0).toUpperCase() + b.slice(1), d = b, f = qb.length; f--; )
            if (b = qb[f] + c,
            b in a)
                return b;
        return d
    ...
    function rb(a, b) {
        for (var c, e, f, g = [], h = 0, k = a.length; h < k; h++)
            e = a[h],
            e.style && (g[h] = d._data(e, "olddisplay"),
            c = e.style.display,
            b ? (g[h] || "none" !== c || (e.style.display = ""),
            "" === e.style.display && ja(e) && (g[h] = d._data(e, "olddisplay", qa(e.nodeName)))) : (f = ja(e),
            (c && "none" !== c || !f) && d._data(e, "olddisplay", f ? c : d.css(e, "display"))));
        for (h = 0; h < k; h++)
            e = a[h],
    ...
    function sb(a, b, c) {
        return (a = gc.exec(b)) ? Math.max(0, a[1] - (c || 0)) + (a[2] || "px") : b
    }
    function tb(a, b, c, e, f) {
        b = c === (e ? "border" : "content") ? 4 : "width" === b ? 1 : 0;
        for (var g = 0; 4 > b; b += 2)
            "margin" === c && (g += d.css(a, c + X[b], !0, f)),
            e ? ("content" === c && (g -= d.css(a, "padding" + X[b], !0, f)),
            "margin" !== c && (g -= d.css(a, "border" + X[b] + "Width", !0, f))) : (g += d.css(a, "padding" + X[b], !0, f),
            "padding" !== c && (g += d.css(a, "border" + X[b] + "Width", !0, f)));
        return g
    }
    function ub(a, b, c) {
        var e = !0
        ...
        return f + tb(a, b, c || (h ? "border" : "content"), e, g) + "px"
    }
    function C(a, b, c, d, f) {
        return new C.prototype.init(a,b,c,d,f)
    }
    function vb() {
        setTimeout(function() {
            Z = void 0
    ...
    function wb(a, b, c) {
        for (var d, f = (ka[b] || []).concat(ka["*"]), g = 0, h = f.length; g < h; g++)
            if (d = f[g].call(c, b, a))
                return d
    }
    function hc(a, b) {
    ...
    function xb(a, b, c) {
        var e, f = 0, g = da.length, h = d.Deferred().always(function() {
            ...
            if (e)
                return !1;
            for (var b = Z || vb(), b = Math.max(0, l.startTime + l.duration - b), c = 1 - (b / l.duration || 0), d = 0, f = l.tweens.length; d < f; d++)
                l.tweens[d].run(c);
        ...
        c = l.props;
        for (hc(c, l.opts.specialEasing); f < g; f++)
    ...
    function yb(a) {
        return function(b, c) {
            "string" !== typeof b && (c = b,
            b = "*");
            var e, f = 0, g = b.toLowerCase().match(N) || [];
            if (d.isFunction(c))
                for (; e = g[f++]; )
    ...
    function Ma(a, b, c, e) {
        ...
        if (d.isArray(b))
            d.each(b, function(b, d) {
                c || ic.test(a) ? e(a, d) : Ma(a + "[" + ("object" === typeof d ? b : "") + "]", d, c, e)
            });
        ...
        for (; h < k; h++)
            if (null != (f = arguments[h]))
                for (e in f)
                    a = g[e],
                    c = f[e],
                    g !== c && (l && c && (d.isPlainObject(c) || (b = d.isArray(c))) ? (b ? (b = !1,
                    a = a && d.isArray(a) ? a : []) : a = a && d.isPlainObject(a) ? a : {},
                    g[e] = d.extend(l, a, c)) : void 0 !== c && (g[e] = c));
        return g
    }
    ;
    d.extend({
        ...
        isPlainObject: function(a) {
            ...
            if (!a || "object" !== d.type(a) || a.nodeType || d.isWindow(a))
                return !1;
            try {
                if (a.constructor && !T.call(a, "constructor") && !T.call(a.constructor.prototype, "isPrototypeOf"))
                    return !1
            } catch (c) {
                return !1
            }
            ...
            for (b in a)
                ;
            return void 0 === b || T.call(a, b)
        },
        type: function(a) {
            return null == a ? a + "" : "object" === typeof a || "function" === typeof a ? ta[jc.call(a)] || "object" : typeof a
        },
        ...
        makeArray: function(a, b) {
            var c = b || [];
            null != a && (Fa(Object(a)) ? d.merge(c, "string" === typeof a ? [a] : a) : Na.call(c, a));
            return c
        },
        ...
        merge: function(a, b) {
            for (var c = +b.length, d = 0, f = a.length; d < c; )
                a[f++] = b[d++];
            if (c !== c)
                for (; void 0 !== b[d]; )
                    a[f++] = b[d++];
        ...
        proxy: function(a, b) {
            ...
            if (d.isFunction(a))
                ...
                e = function() {
                    return a.apply(b || this, c.concat(P.call(arguments)))
                }
                ,
    ...
    var ga = function(a) {
            ...
            if (!d && G) {
                if (11 !== h && (e = sa.exec(a)))
                    if (g = e[1])
                        if (9 === h)
                            ...
                            if (b.ownerDocument && (f = b.ownerDocument.getElementById(g)) && va(b, f) && f.id === g)
                                return c.push(f),
                                c
                        }
                    else {
                ...
                if (v.qsa && (!w || !w.test(a))) {
                    ...
                    if (1 === h && "object" !== b.nodeName.toLowerCase()) {
                        h = wa(a);
                        (e = b.getAttribute("id")) ? f = e.replace(ta, "\\$&") : b.setAttribute("id", f);
                        f = "[id='" + f + "'] ";
                        for (g = h.length; g--; )
                            h[g] = f + p(h[g]);
                        g = da.test(a) && u(b.parentNode) || b;
                        k = h.join(",")
                    }
                    if (k)
                        try {
                            return ea.apply(c, g.querySelectorAll(k)),
                            c
                        } catch (l) {} finally {
        ...
        function Pa(a, c, f, g, h, k) {
            g && !g[x] && (g = Pa(g));
            h && !h[x] && (h = Pa(h, k));
            return d(function(d, e, k, l) {
                var m, r, u = [], p = [], t = e.length, A;
                if (!(A = d)) {
                    A = c || "*";
                    for (var n = k.nodeType ? [k] : k, Eb = [], q = 0, z = n.length; q < z; q++)
                        b(A, n[q], Eb);
                    A = Eb
                }
                A = !a || !d && c ? A : y(A, u, a, k, l);
                n = f ? h || (d ? a : t || g) ? [] : e : A;
                f && f(A, n, k, l);
                if (g)
                    for (m = y(n, p),
                ...
                if (d) {
                    if (h || a) {
                        ...
                        for (k = n.length; k--; )
                            (r = n[k]) && -1 < (m = h ? E(d, r) : u[k]) && (d[m] = !(e[m] = r))
                    }
                } else
                    n = y(n === e ? n.splice(t, n.length) : n),
                    h ? h(null , e, n, l) : ea.apply(e, n)
            })
        }
        function C(a) {
            ...
            for (var g = f ? 1 : 0, h = n(function(a) {
                ...
                a = !f && (d || c !== ya) || ((b = c).nodeType ? h(a, c, d) : k(a, c, d));
                b = null ;
                return a
            }
            ]; g < e; g++)
                if (c = t.relative[a[g].type])
                    l = [n(q(l), c)];
                else {
                    ...
                    if (c[x]) {
                        for (d = ++g; d < e && !t.relative[a[d].type]; d++)
                            ;
                        return Pa(1 < g && q(l), 1 < g && p(a.slice(0, g - 1).concat({
                            value: " " === a[g - 2].type ? "*" : ""
                        })).replace(Q, "$1"), c, g < d && C(a.slice(g, d)), d < e && C(a = a.slice(d)), d < e && p(a))
                    }
                    l.push(c)
                }
            return q(l)
        ...
        function D(a, c) {
            var f = 0 < c.length
              ...
              , h = function(d, e, h, k, l) {
                var m, r, u, p = 0, n = "0", A = d && [], la = [], q = ya, z = d || g && t.find.TAG("*", l), w = M += null == q ? 1 : Math.random() || .1, x = z.length;
                for (l && (ya = e !== B && e); n !== x && null != (m = z[n]); n++) {
                    if (g && m) {
                        for (r = 0; u = a[r++]; )
                            if (u(m, e, h)) {
                                k.push(m);
                ...
                if (f && n !== p) {
                    ...
                    if (d) {
                        if (0 < p)
                            for (; n--; )
                                A[n] || la[n] || (la[n] = Y.call(k));
                        la = y(la)
                    }
                    ea.apply(k, la);
                    l && !d && 0 < la.length && 1 < p + c.length && b.uniqueSort(k)
                }
                l && (M = w,
                ya = q);
                return A
        ...
        var K, v, t, ma, Fb, wa, Qa, N, ya, fa, ua, J, B, L, G, w, na, za, va, x = "sizzle" + 1 * new Date, H = a.document, M = 0, S = 0, I = c(), P = c(), R = c(), O = function(a, b) {
            a === b && (ua = !0);
            return 0
        }, X = {}.hasOwnProperty, F = [], Y = F.pop, ca = F.push, ea = F.push, U = F.slice, E = function(a, b) {
            for (var c = 0, d = a.length; c < d; c++)
                if (a[c] === b)
                    return c;
            return -1
        }, W = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w", "w#"), Z = "\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:[\\x20\\t\\r\\n\\f]*([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + W + "))|)[\\x20\\t\\r\\n\\f]*\\]", T = ":((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + Z + ")*)|.*)\\)|)", ga = /[\x20\t\r\n\f]+/g, Q = /^[\x20\t\r\n\f]+|((?:^|[^\\])(?:\\.)*)[\x20\t\r\n\f]+$/g, ha = /^[\x20\t\r\n\f]*,[\x20\t\r\n\f]*/, ia = /^[\x20\t\r\n\f]*([>+~]|[\x20\t\r\n\f])[\x20\t\r\n\f]*/, ja = /=[\x20\t\r\n\f]*([^\]'"]*?)[\x20\t\r\n\f]*\]/g, ka = new RegExp(T), oa = new RegExp("^" + W + "$"), V = {
            ID: /^#((?:\\.|[\w-]|[^\x00-\xa0])+)/,
            CLASS: /^\.((?:\\.|[\w-]|[^\x00-\xa0])+)/,
        ...
        }, qa = /^(?:input|select|textarea|button)$/i, ra = /^h\d$/i, xa = /^[^{]+\{\s*\[native \w/, sa = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, da = /[+~]/, ta = /'|\\/g, aa = /\\([\da-f]{1,6}[\x20\t\r\n\f]?|([\x20\t\r\n\f])|.)/ig, ba = function(a, b, c) {
            a = "0x" + b - 65536;
        ...
        try {
            ea.apply(F = U.call(H.childNodes), H.childNodes),
            F[H.childNodes.length].nodeType
        } catch (Uc) {
            ea = {
        ...
        J = b.setDocument = function(a) {
            ...
            B = b;
            L = b.documentElement;
            (a = b.defaultView) && a !== a.top && (a.addEventListener ? a.addEventListener("unload", pa, !1) : a.attachEvent && a.attachEvent("onunload", pa));
            G = !Fb(b);
            ...
            v.getElementsByClassName = xa.test(b.getElementsByClassName);
            v.getById = f(function(a) {
                L.appendChild(a).id = x;
            ...
            na = [];
            w = [];
            if (v.qsa = xa.test(b.querySelectorAll))
                f(function(a) {
                    L.appendChild(a).innerHTML = "<a id='" + x + "'></a><select id='" + x + "-\f]' msallowcapture=''><option selected=''></option></select>";
                    ...
                    a.querySelectorAll("[id~=" + x + "-]").length || w.push("~=");
                    a.querySelectorAll(":checked").length || w.push(":checked");
                    a.querySelectorAll("a#" + x + "+*").length || w.push(".#.+[+~]")
                }),
                f(function(a) {
            ...
            (v.matchesSelector = xa.test(za = L.matches || L.webkitMatchesSelector || L.mozMatchesSelector || L.oMatchesSelector || L.msMatchesSelector)) && f(function(a) {
                v.disconnectedMatch = za.call(a, "div");
                za.call(a, "[s!='']:x");
                na.push("!=", T)
            });
            w = w.length && new RegExp(w.join("|"));
            na = na.length && new RegExp(na.join("|"));
            va = (a = xa.test(L.compareDocumentPosition)) || xa.test(L.contains) ? function(a, b) {
            ...
            O = a ? function(a, c) {
                ...
                return d & 1 || !v.sortDetached && c.compareDocumentPosition(a) === d ? a === b || a.ownerDocument === H && va(H, a) ? -1 : c === b || c.ownerDocument === H && va(H, c) ? 1 : fa ? E(fa, a) - E(fa, c) : 0 : d & 4 ? -1 : 1
            }
            : function(a, c) {
                if (a === c)
                    return ua = !0,
                ...
                var f = c.parentNode
                  ...
                  , k = [c];
                if (!d || !f)
                    return a === b ? -1 : c === b ? 1 : d ? -1 : f ? 1 : fa ? E(fa, a) - E(fa, c) : 0;
                if (d === f)
                    return h(a, c);
                ...
                for (; g[e] === k[e]; )
                    e++;
                return e ? h(g[e], k[e]) : g[e] === H ? -1 : k[e] === H ? 1 : 0
            }
            ;
            return b
        }
        ...
        b.matchesSelector = function(a, c) {
            (a.ownerDocument || a) !== B && J(a);
            c = c.replace(ja, "='$1']");
            if (!(!v.matchesSelector || !G || na && na.test(c) || w && w.test(c)))
                try {
                    var d = za.call(a, c);
        ...
        b.attr = function(a, b) {
            ...
            var c = t.attrHandle[b.toLowerCase()]
              , c = c && X.call(t.attrHandle, b.toLowerCase()) ? c(a, b, !G) : void 0;
            return void 0 !== c ? c : v.attributes || !G ? a.getAttribute(b) : (c = a.getAttributeNode(b)) && c.specified ? c.value : null
        }
        ;
        b.error = function(a) {
        ...
        t = b.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(a) {
                    ...
                    if (V.CHILD.test(a[0]))
                        return null ;
                    a[3] ? a[2] = a[4] || a[5] || "" : c && ka.test(c) && (b = wa(c, !0)) && (b = c.indexOf(")", c.length - b) - c.length) && (a[0] = a[0].slice(0, b),
                    a[2] = c.slice(0, b));
                    return a.slice(0, 3)
                }
            },
            filter: {
                ...
                ATTR: function(a, c, d) {
                    return function(e) {
                        ...
                        if (!c)
                            return !0;
                        e += "";
                        return "=" === c ? e === d : "!=" === c ? e !== d : "^=" === c ? d && 0 === e.indexOf(d) : "*=" === c ? d && -1 < e.indexOf(d) : "$=" === c ? d && e.slice(-d.length) === d : "~=" === c ? -1 < (" " + e.replace(ga, " ") + " ").indexOf(d) : "|=" === c ? e === d || e.slice(0, d.length + 1) === d + "-" : !1
                    }
                },
                    ...
                    : function(b, c, k) {
                        ...
                        if (n) {
                            if (f) {
                                for (; c; ) {
                                    for (m = b; m = m[c]; )
                                        if (h ? m.nodeName.toLowerCase() === A : 1 === m.nodeType)
                                            return !1;
                            ...
                            if (g && k)
                                ...
                                u = l[0] === M && l[1],
                                r = l[0] === M && l[2],
                                m = u && n.childNodes[u]; m = ++u && m && m[c] || (r = u = 0) || p.pop(); ) {
                                    if (1 === m.nodeType && ++r && m === b) {
                                        k[a] = [M, u, r];
                                        break
                                    }
                                }
                            else if (k && (l = (b[x] || (b[x] = {}))[a]) && l[0] === M)
                                r = l[1];
                            else
                                for (; (m = ++u && m && m[c] || (r = u = 0) || p.pop()) && ((h ? m.nodeName.toLowerCase() !== A : 1 !== m.nodeType) || !++r || (k && ((m[x] || (m[x] = {}))[a] = [M, r]),
                                m !== b)); )
                                    ;
                            r -= e;
                ...
                PSEUDO: function(a, c) {
                    var f, g = t.pseudos[a] || t.setFilters[a.toLowerCase()] || b.error("unsupported pseudo: " + a);
                    return g[x] ? g(c) : 1 < g.length ? (f = [a, a, "", c],
                    t.setFilters.hasOwnProperty(a.toLowerCase()) ? d(function(a, b) {
        ...
        wa = b.tokenize = function(a, c) {
            ...
            for (l = t.preFilter; h; ) {
                ...
                if (e = ia.exec(h))
                    ...
                    h = h.slice(d.length);
                for (g in t.filter)
                    !(e = V[g].exec(h)) || l[g] && !(e = l[g](e)) || (d = e.shift(),
                    f.push({
                        value: d,
                        type: g,
                        matches: e
        ...
        ;
        N = b.select = function(a, b, c, d) {
            var e, f, g, h, k = "function" === typeof a && a, l = !d && wa(a = k.selector || a);
            c = c || [];
            if (1 === l.length) {
                f = l[0] = l[0].slice(0);
                if (2 < f.length && "ID" === (g = f[0]).type && v.getById && 9 === b.nodeType && G && t.relative[f[1].type]) {
                    b = (t.find.ID(g.matches[0].replace(aa, ba), b) || [])[0];
                    if (!b)
                        return c;
                    k && (b = b.parentNode);
                ...
                for (e = V.needsContext.test(a) ? 0 : f.length; e--; ) {
                    ...
                    if (t.relative[h = g.type])
                        break;
                    if (h = t.find[h])
                        if (d = h(g.matches[0].replace(aa, ba), da.test(f[0].type) && u(b.parentNode) || b)) {
                            f.splice(e, 1);
                            a = d.length && p(f);
                            if (!a)
                                return ea.apply(c, d),
            ...
            (k || Qa(a, l))(d, b, !G, c, da.test(a) && u(b.parentNode) || b);
            return c
        }
        ;
        v.sortStable = x.split("").sort(O).join("") === x;
    ...
    d.unique = ga.uniqueSort;
    d.text = ga.getText;
    d.isXMLDoc = ga.isXML;
    d.contains = ga.contains;
    var Gb = d.expr.match.needsContext
      , Hb = /^<(\w+)\s*\/?>(?:<\/\1>|)$/
      , ac = /^.[^:#\[\.,]*$/;
    ...
    d.fn.extend({
        ...
        filter: function(a) {
            return this.pushStack(Ga(this, a || [], !1))
        },
        not: function(a) {
            return this.pushStack(Ga(this, a || [], !0))
        },
        is: function(a) {
            return !!Ga(this, "string" === typeof a && Gb.test(a) ? d(a) : a || [], !1).length
        }
    });
    ...
    var oa, n = q.document, oc = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;
    (d.fn.init = function(a, b) {
        var c, e;
        if (!a)
            return this;
        if ("string" === typeof a) {
            c = "<" === a.charAt(0) && ">" === a.charAt(a.length - 1) && 3 <= a.length ? [null , a, null ] : oc.exec(a);
            if (!c || !c[1] && b)
                return !b || b.jquery ? (b || oa).find(a) : this.constructor(b).find(a);
            if (c[1]) {
                if (b = b instanceof d ? b[0] : b,
                d.merge(this, d.parseHTML(c[1], b && b.nodeType ? b.ownerDocument || b : n, !0)),
                Hb.test(c[1]) && d.isPlainObject(b))
                    for (c in b)
        ...
        if (a.nodeType)
            ...
            this;
        if (d.isFunction(a))
            return "undefined" !== typeof oa.ready ? oa.ready(a) : a(d);
    ...
    d.extend({
        dir: function(a, b, c) {
            var e = [];
            for (a = a[b]; a && 9 !== a.nodeType && (void 0 === c || 1 !== a.nodeType || !d(a).is(c)); )
    ...
    d.fn.extend({
        ...
        closest: function(a, b) {
            for (var c, e = 0, f = this.length, g = [], h = Gb.test(a) || "string" !== typeof a ? d(a, b || this.context) : 0; e < f; e++)
    ...
    d.each({
        ...
        d.fn[a] = function(c, e) {
            ...
            1 < this.length && (qc[a] || (f = d.unique(f)),
            pc.test(a) && (f = f.reverse()));
    ...
    d.Callbacks = function(a) {
        a = "string" === typeof a ? ab[a] || bc(a) : d.extend({}, a);
        var b, c, e, f, g, h, k = [], l = !a.once && [], r = function(d) {
            ...
            b = !1;
            k && (l ? l.length && r(l.shift()) : c ? k = [] : u.disable())
        }, u = {
            add: function() {
                if (k) {
                    var e = k.length;
                    (function z(b) {
                        d.each(b, function(b, c) {
                            var e = d.type(c);
                            "function" === e ? a.unique && u.has(c) || k.push(c) : c && c.length && "string" !== e && z(c)
                        })
                    })(arguments);
                    b ? f = k.length : c && (h = e,
                    r(c))
    ...
    d.extend({
                        ...
                        d.each(b, function(b, l) {
                            ...
                            f[l[1]](function() {
                                ...
                                if (a && d.isFunction(a.promise))
                                    ...
                                    c[l[0] + "With"](this === e ? c.promise() : this, r ? [a] : arguments)
                            })
                        });
                        a = null
                    }).promise()
        ...
        when: function(a) {
            var b = 0, c = P.call(arguments), e = c.length, f = 1 !== e || a && d.isFunction(a.promise) ? e : 0, g = 1 === f ? a : d.Deferred(), h = function(a, b, c) {
                return function(d) {
                    b[a] = this;
            ...
            if (1 < e)
                ...
                l = Array(e),
                r = Array(e); b < e; b++)
                    c[b] && d.isFunction(c[b].promise) ? c[b].promise().done(h(b, r, c)).fail(g.reject).progress(h(b, l, k)) : --f;
            f || g.resolveWith(r, c);
            return g.promise()
        }
    });
    ...
    d.extend({
        ...
        ready: function(a) {
            if (!0 === a ? !--d.readyWait : !d.isReady) {
                ...
                d.isReady = !0;
                !0 !== a && 0 < --d.readyWait || (pa.resolveWith(n, [d]),
    ...
    d.ready.promise = function(a) {
        if (!pa)
            ...
            "complete" === n.readyState)
                ...
                n.addEventListener("DOMContentLoaded", S, !1),
                q.addEventListener("load", S, !1);
            else {
    ...
    d(function() {
        var a, b, c;
        (b = n.getElementsByTagName("body")[0]) && b.style && (a = n.createElement("div"),
        ...
        p.inlineBlockNeedsLayout = a = 3 === a.offsetWidth) && (b.style.zoom = 1),
        b.removeChild(c))
    });
    (function() {
    ...
    d.fn.extend({
        data: function(a, b) {
            ...
            if (void 0 === a) {
                if (this.length && (f = d.data(g),
                1 === g.nodeType && !d._data(g, "parsedAttrs"))) {
                    for (c = h.length; c--; )
                        h[c] && (e = h[c].name,
    ...
    d.extend({
        queue: function(a, b, c) {
            ...
            if (a)
                return b = (b || "fx") + "queue",
                e = d._data(a, b),
                c && (!e || d.isArray(c) ? e = d._data(a, b, d.makeArray(c)) : e.push(c)),
                e || []
        },
    ...
    d.fn.extend({
        ...
        promise: function(a, b) {
            ...
            a = void 0);
            for (a = a || "fx"; h--; )
                (c = d._data(g[h], a + "queueHooks")) && c.empty && (e++,
                c.empty.add(k));
            k();
            return f.promise(b)
        }
    ...
    var Aa = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source
      ...
      , ca = d.access = function(a, b, c, e, f, g, h) {
        var k = 0
          , l = a.length
          , r = null == c;
        if ("object" === d.type(c))
    ...
    (function() {
        ...
        for (a in {
            ...
            b = "on" + a,
            (p[a + "Bubbles"] = b in q) || (c.setAttribute(b, "t"),
    ...
    d.event = {
        ...
        add: function(a, b, c, e, f) {
            ...
            if (k = d._data(a)) {
                ...
                for (k = b.length; k--; )
                    ...
                    g.add && (g.add.call(a, p),
                    p.handler.guid || (p.handler.guid = c.guid)),
        ...
        remove: function(a, b, c, e, f) {
            var g, h, k, l, r, n, m, p, q, y, C, F = d.hasData(a) && d._data(a);
            if (F && (n = F.events)) {
                b = (b || "").match(N) || [""];
                for (r = b.length; r--; )
                    if (k = Jb.exec(b[r]) || [],
                    ...
                    q) {
                        ...
                        p = n[q] || [];
                        k = k[2] && new RegExp("(^|\\.)" + y.join("\\.(?:.*\\.|)") + "(\\.|$)");
                        for (l = g = p.length; g--; )
                            h = p[g],
                            !f && C !== h.origType || c && c.guid !== h.guid || k && !k.test(h.namespace) || e && e !== h.selector && ("**" !== e || !h.selector) || (p.splice(g, 1),
                            h.selector && p.delegateCount--,
                            m.remove && m.remove.call(a, h));
                        l && !p.length && (m.teardown && !1 !== m.teardown.call(a, y, F.handle) || d.removeEvent(a, q, F.handle),
                        delete n[q])
                    } else
                        for (q in n)
                            d.event.remove(a, q + b[r], c, e, !0);
                d.isEmptyObject(n) && (delete F.handle,
                d._removeData(a, "events"))
            }
        },
        trigger: function(a, b, c, e) {
            var f, g, h, k, l, r, p = [c || n], m = T.call(a, "type") ? a.type : a;
            l = T.call(a, "namespace") ? a.namespace.split(".") : [];
            h = f = c = c || n;
            if (3 !== c.nodeType && 8 !== c.nodeType && !Ib.test(m + d.event.triggered) && (0 <= m.indexOf(".") && (l = m.split("."),
            m = l.shift(),
            l.sort()),
            g = 0 > m.indexOf(":") && "on" + m,
            ...
            e || !l.trigger || !1 !== l.trigger.apply(c, b))) {
                ...
                for (r = 0; (h = p[r++]) && !a.isPropagationStopped(); )
                    ...
                    (f = (d._data(h, "events") || {})[a.type] && d._data(h, "handle")) && f.apply(h, b),
                    (f = g && h[g]) && f.apply && d.acceptData(h) && (a.result = f.apply(h, b),
        ...
        dispatch: function(a) {
            a = d.event.fix(a);
            var b, c, e, f, g = [], h = P.call(arguments);
            ...
            if (!k.preDispatch || !1 !== k.preDispatch.call(this, a)) {
                ...
                for (b = 0; (e = g[b++]) && !a.isPropagationStopped(); )
                    ...
                    f = 0; (c = e.handlers[f++]) && !a.isImmediatePropagationStopped(); )
                ...
                for (; l != this; l = l.parentNode || this)
                    if (1 === l.nodeType && (!0 !== l.disabled || "click" !== a.type)) {
                        ...
                        for (g = 0; g < k; g++)
                            e = b[g],
                            c = e.selector + " ",
                            void 0 === f[c] && (f[c] = e.needsContext ? 0 <= d(c, this).index(l) : d.find(c, this, null , [l]).length),
                            f[c] && f.push(e);
                        f.length && h.push({
                            elem: l,
                            handlers: f
        ...
        fix: function(a) {
            ...
            var f = a
              , g = this.fixHooks[b];
            g || (this.fixHooks[b] = g = tc.test(b) ? this.mouseHooks : sc.test(b) ? this.keyHooks : {});
        ...
        mouseHooks: {
            ...
            filter: function(a, b) {
                ...
                null == a.pageX && null != b.clientX && (c = a.target.ownerDocument || n,
                d = c.documentElement,
                c = c.body,
    ...
    d.Event = function(a, b) {
        ...
        this.type = a.type,
        this.isDefaultPrevented = a.defaultPrevented || void 0 === a.defaultPrevented && !1 === a.returnValue ? V : W) : this.type = a;
        b && d.extend(this, b);
    ...
    p.changeBubbles || (d.event.special.change = {
        setup: function() {
            ...
            d.event.add(this, "beforeactivate._change", function(a) {
                a = a.target;
                Ra.test(a.nodeName) && !d._data(a, "changeBubbles") && (d.event.add(a, "change._change", function(a) {
    ...
    p.focusinBubbles || d.each({
        ...
        d.event.special[b] = {
            ...
            teardown: function() {
                var e = this.ownerDocument || this
                  , f = d._data(e, b) - 1;
                f ? d._data(e, b, f) : (e.removeEventListener(a, c, !0),
                d._removeData(e, b))
            }
        }
    });
    ...
    d.extend({
        clone: function(a, b, c) {
            ...
            p.html5Clone || d.isXMLDoc(a) || !Kb.test("<" + a.nodeName + ">") ? g = a.cloneNode(!0) : (Ta.innerHTML = a.outerHTML,
            Ta.removeChild(g = Ta.firstChild));
                    ...
                    if (e[h]) {
                        ...
                        if (1 === r.nodeType) {
                            ...
                            if ("script" === n && r.text !== f.text)
                                ...
                                p.html5Clone && f.innerHTML && !d.trim(r.innerHTML) && (r.innerHTML = f.innerHTML);
                            else if ("input" === n && Ia.test(f.type))
            ...
            if (b)
                if (c)
                    ...
                    lb(a, g);
            e = y(g, "script");
            0 < e.length && Ja(e, !l && y(a, "script"));
            return g
        },
        buildFragment: function(a, b, c, e) {
            for (var f, g, h, k, l, r, n = a.length, m = gb(b), q = [], z = 0; z < n; z++)
                if ((g = a[z]) || 0 === g)
                    if ("object" === d.type(g))
                        d.merge(q, g.nodeType ? [g] : g);
                    else if (vc.test(g)) {
                        h = h || m.appendChild(b.createElement("div"));
                        k = (Mb.exec(g) || ["", ""])[1].toLowerCase();
                        r = D[k] || D._default;
                        h.innerHTML = r[1] + g.replace(Lb, "<$1></$2>") + r[2];
                        for (f = r[0]; f--; )
                            h = h.lastChild;
                        !p.leadingWhitespace && Sa.test(g) && q.push(b.createTextNode(Sa.exec(g)[0]));
                        if (!p.tbody)
                            for (f = (g = "table" !== k || Nb.test(g) ? "<table>" !== r[1] || Nb.test(g) ? 0 : h : h.firstChild) && g.childNodes.length; f--; )
                                d.nodeName(l = g.childNodes[f], "tbody") && !l.childNodes.length && g.removeChild(l);
            ...
            h && m.removeChild(h);
            p.appendChecked || d.grep(y(q, "input"), ec);
            for (z = 0; g = q[z++]; )
                if (!e || -1 === d.inArray(g, e))
                    if (a = d.contains(g.ownerDocument, g),
                    h = y(m.appendChild(g), "script"),
                    a && Ja(h),
                    c)
                        for (f = 0; g = h[f++]; )
                            Ob.test(g.type || "") && c.push(g);
            return m
        },
            ...
            for (var c, e, f, g, h = 0, k = d.expando, l = d.cache, r = p.deleteExpando, n = d.event.special; null != (c = a[h]); h++)
                if (b || d.acceptData(c))
                    if (g = (f = c[k]) && l[f]) {
                        ...
                        l[f] && (delete l[f],
                        r ? delete c[k] : "undefined" !== typeof c.removeAttribute ? c.removeAttribute(k) : c[k] = null ,
                        I.push(f))
                    }
        }
    });
    d.fn.extend({
        ...
        remove: function(a, b) {
            for (var c, e = a ? d.filter(a, this) : this, f = 0; null != (c = e[f]); f++)
                b || 1 !== c.nodeType || d.cleanData(y(c)),
                c.parentNode && (b && d.contains(c.ownerDocument, c) && Ja(y(c, "script")),
                c.parentNode.removeChild(c));
            return this
        },
        empty: function() {
            for (var a, b = 0; null != (a = this[b]); b++) {
                for (1 === a.nodeType && d.cleanData(y(a, !1)); a.firstChild; )
        ...
        html: function(a) {
            return ca(this, function(a) {
                var c = this[0] || {}
                  ...
                  , f = this.length;
                if (void 0 === a)
                    return 1 === c.nodeType ? c.innerHTML.replace(uc, "") : void 0;
                if (!("string" !== typeof a || wc.test(a) || !p.htmlSerialize && Kb.test(a) || !p.leadingWhitespace && Sa.test(a) || D[(Mb.exec(a) || ["", ""])[1].toLowerCase()])) {
                    a = a.replace(Lb, "<$1></$2>");
                    try {
                        for (; e < f; e++)
                            c = this[e] || {},
                            1 === c.nodeType && (d.cleanData(y(c, !1)),
                            c.innerHTML = a);
                        c = 0
                    } catch (g) {}
                }
        ...
        domManip: function(a, b) {
            ...
            if (m || 1 < k && "string" === typeof n && !p.checkClone && xc.test(n))
                return this.each(function(c) {
                    var d = l.eq(c);
                    m && (a[0] = n.call(this, c, d.html()));
                    d.domManip(a, b)
                });
            if (k && (g = d.buildFragment(a, this[0].ownerDocument, !1, this),
            c = g.firstChild,
            1 === g.childNodes.length && (g = c),
            c)) {
                f = d.map(y(g, "script"), jb);
                for (e = f.length; h < k; h++)
                    c = g,
                    h !== r && (c = d.clone(c, !0, !0),
                    e && d.merge(f, y(c, "script"))),
                    b.call(this[h], c, h);
                if (e)
                    ...
                    h = 0; h < e; h++)
                        c = f[h],
                        Ob.test(c.type || "") && !d._data(c, "globalEval") && d.contains(g, c) && (c.src ? d._evalUrl && d._evalUrl(c.src) : d.globalEval((c.text || c.textContent || c.innerHTML || "").replace(yc, "")));
                g = c = null
            }
            return this
        }
    ...
    var Pb = /^margin/, ra = new RegExp("^(" + Aa + ")(?!px)[a-z%]+$","i"), F, Y, zc = /^(top|right|bottom|left)$/;
    ...
    Y = function(a, b, c) {
        var e, f, g = a.style;
        f = (c = c || F(a)) ? c.getPropertyValue(b) || c[b] : void 0;
        c && ("" !== f || d.contains(a.ownerDocument, a) || (f = d.style(a, b)),
        ra.test(f) && Pb.test(b) && (a = g.width,
        b = g.minWidth,
        e = g.maxWidth,
    ...
    Y = function(a, b, c) {
        var d, f, g, h = a.style;
        g = (c = c || F(a)) ? c[b] : void 0;
        null == g && h && h[b] && (g = h[b]);
        if (ra.test(g) && !zc.test(b)) {
            c = h.left;
    ...
    (function() {
        function a() {
            ...
            if ((b = n.getElementsByTagName("body")[0]) && b.style) {
                ...
                e = f = !1;
                h = !0;
                q.getComputedStyle && (e = "1%" !== (q.getComputedStyle(a, null ) || {}).top,
                f = "4px" === (q.getComputedStyle(a, null ) || {
                    width: "4px"
                }).width,
    ...
    d.extend({
        ...
        style: function(a, b, c, e) {
            if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
                ...
                b = d.cssProps[k] || (d.cssProps[k] = pb(l, k));
                h = d.cssHooks[b] || d.cssHooks[k];
                if (void 0 !== c) {
                    if (g = typeof c,
                    "string" === g && (f = Cc.exec(c)) && (c = (f[1] + 1) * f[2] + parseFloat(d.css(a, b)),
                    g = "number"),
                    null != c && c === c && ("number" !== g || d.cssNumber[k] || (c += "px"),
                    p.clearCloneStyle || "" !== c || 0 !== b.indexOf("background") || (l[b] = "inherit"),
        ...
        css: function(a, b, c, e) {
            var f, g;
            g = d.camelCase(b);
            b = d.cssProps[g] || (d.cssProps[g] = pb(a.style, g));
            (g = d.cssHooks[b] || d.cssHooks[g]) && "get"in g && (f = g.get(a, !0, c));
            void 0 === f && (f = Y(a, b, e));
            "normal" === f && b in Qb && (f = Qb[b]);
            return "" === c || c ? (a = parseFloat(f),
            !0 === c || d.isNumeric(a) ? a || 0 : f) : f
        }
    });
    d.each(["height", "width"], function(a, b) {
        d.cssHooks[b] = {
            get: function(a, e, f) {
                if (e)
                    return Bc.test(d.css(a, "display")) && 0 === a.offsetWidth ? d.swap(a, Dc, function() {
                        return ub(a, b, f)
                    }) : ub(a, b, f)
            },
            set: function(a, e, f) {
                var g = f && F(a);
                return sb(a, e, f ? tb(a, b, f, p.boxSizing && "border-box" === d.css(a, "boxSizing", !1, g), g) : 0)
            }
        }
    });
    p.opacity || (d.cssHooks.opacity = {
        get: function(a, b) {
            return Ac.test((b && a.currentStyle ? a.currentStyle.filter : a.style.filter) || "") ? .01 * parseFloat(RegExp.$1) + "" : b ? "1" : ""
        },
        set: function(a, b) {
            var c = a.style
              , e = a.currentStyle
            ...
            c.zoom = 1;
            if ((1 <= b || "" === b) && "" === d.trim(g.replace(Ua, "")) && c.removeAttribute && (c.removeAttribute("filter"),
            "" === b || e && !e.filter))
                return;
            c.filter = Ua.test(g) ? g.replace(Ua, f) : g + " " + f
        }
    });
    d.cssHooks.marginRight = ob(p.reliableMarginRight, function(a, b) {
        if (b)
            return d.swap(a, {
        ...
        d.cssHooks[a + b] = {
            expand: function(c) {
                ...
                for (c = "string" === typeof c ? c.split(" ") : [c]; 4 > d; d++)
                    f[a + X[d] + b] = c[d] || c[d - 2] || c[0];
                return f
            }
        };
        Pb.test(a) || (d.cssHooks[a + b].set = sb)
    });
    d.fn.extend({
        css: function(a, b) {
    ...
    d.fx.step = {};
    var Z, Ba, Ec = /^(?:toggle|show|hide)$/, Rb = new RegExp("^(?:([+-])=|)(" + Aa + ")([a-z%]*)$","i"), Fc = /queueHooks$/, da = [function(a, b, c) {
        var e, f, g, h, k, l, n = this, q = {}, m = a.style, A = a.nodeType && ja(a), z = d._data(a, "fxshow");
        c.queue || (h = d._queueHooks(a, "fx"),
        ...
        l = d.css(a, "display"),
        f = "none" === l ? d._data(a, "olddisplay") || qa(a.nodeName) : l,
        "inline" === f && "none" === d.css(a, "float") && (p.inlineBlockNeedsLayout && "inline" !== qa(a.nodeName) ? m.zoom = 1 : m.display = "inline-block"));
        c.overflow && (m.overflow = "hidden",
        p.shrinkWrapBlocks() || n.always(function() {
        ...
        for (e in b)
            ...
            Ec.exec(f)) {
                ...
                g = g || "toggle" === f;
                if (f === (A ? "hide" : "show"))
                    if ("show" === f && z && void 0 !== z[e])
                        A = !0;
                    else
                        continue;
                q[e] = z && z[e] || d.style(a, e)
            } else
                l = void 0;
        if (d.isEmptyObject(q))
            "inline" === ("none" === l ? qa(a.nodeName) : l) && (m.display = l);
        else
            for (e in z ? "hidden"in z && (A = z.hidden) : z = d._data(a, "fxshow", {}),
            g && (z.hidden = !A),
            A ? d(a).show() : n.done(function() {
                d(a).hide()
            }),
            n.done(function() {
                var b;
        ...
        "*": [function(a, b) {
            var c = this.createTween(a, b)
              ...
              , h = (d.cssNumber[a] || "px" !== g && +e) && Rb.exec(d.css(c.elem, a))
              , k = 1
              , l = 20;
            if (h && h[3] !== g) {
                g = g || h[3];
        ...
        stop: function(a, b, c) {
            ...
            return this.each(function() {
                ...
                if (g)
                    ...
                    for (g in k)
                        k[g] && k[g].stop && Fc.test(g) && e(k[g]);
                for (g = h.length; g--; )
                    h[g].elem !== this || null != a && h[g].queue !== a || (h[g].anim.stop(c),
                    b = !1,
                    h.splice(g, 1));
    ...
    d.fx.interval = 13;
    d.fx.start = function() {
        Ba || (Ba = setInterval(d.fx.tick, d.fx.interval))
    }
    ;
    d.fx.stop = function() {
        clearInterval(Ba);
            ...
            select: {
                get: function(a) {
                    for (var b, c = a.options, e = a.selectedIndex, f = (a = "select-one" === a.type || 0 > e) ? null : [], g = a ? e + 1 : c.length, h = 0 > e ? g : a ? e : 0; h < g; h++)
                        if (b = c[h],
                        !(!b.selected && h !== e || (p.optDisabled ? b.disabled : null !== b.getAttribute("disabled")) || b.parentNode.disabled && d.nodeName(b.parentNode, "optgroup"))) {
                            b = d(b).val();
                            if (a)
                                return b;
                            f.push(b)
                ...
                set: function(a, b) {
                    for (var c, e, f = a.options, g = d.makeArray(b), h = f.length; h--; )
                        if (e = f[h],
                        0 <= d.inArray(d.valHooks.option.get(e), g))
                            try {
                                e.selected = c = !0
                            } catch (k) {
                                e.scrollHeight
    ...
    var Q, Sb, R = d.expr.attrHandle, Va = /^(?:checked|selected)$/i, U = p.getSetAttribute, Ca = p.input;
    d.fn.extend({
        attr: function(a, b) {
            return ca(this, d.attr, a, b, 1 < arguments.length)
        },
    ...
    d.extend({
        attr: function(a, b, c) {
            ...
            if (a && 3 !== g && 8 !== g && 2 !== g) {
                if ("undefined" === typeof a.getAttribute)
                    return d.prop(a, b, c);
                1 === g && d.isXMLDoc(a) || (b = b.toLowerCase(),
                e = d.attrHooks[b] || (d.expr.match.bool.test(b) ? Sb : Q));
                if (void 0 !== c)
                    if (null === c)
                        d.removeAttr(a, b);
                    else {
                        if (e && "set"in e && void 0 !== (f = e.set(a, c, b)))
                            return f;
                        a.setAttribute(b, c + "");
                        return c
                    }
        ...
        removeAttr: function(a, b) {
            var c, e, f = 0, g = b && b.match(N);
            if (g && 1 === a.nodeType)
                for (; c = g[f++]; )
                    e = d.propFix[c] || c,
                    d.expr.match.bool.test(c) ? Ca && U || !Va.test(c) ? a[e] = !1 : a[d.camelCase("default-" + c)] = a[e] = !1 : d.attr(a, c, ""),
    ...
    Sb = {
        set: function(a, b, c) {
            !1 === b ? d.removeAttr(a, c) : Ca && U || !Va.test(c) ? a.setAttribute(!U && d.propFix[c] || c, c) : a[d.camelCase("default-" + c)] = a[c] = !0;
            return c
        }
    };
    d.each(d.expr.match.bool.source.match(/\w+/g), function(a, b) {
        var c = R[b] || d.find.attr;
        R[b] = Ca && U || !Va.test(b) ? function(a, b, d) {
            var h, k;
            d || (k = R[b],
            R[b] = h,
    ...
    Ca && U || (d.attrHooks.value = {
        set: function(a, b, c) {
            if (d.nodeName(a, "input"))
                a.defaultValue = b;
            else
                return Q && Q.set(a, b, c)
        }
    });
    U || (Q = {
        set: function(a, b, c) {
    ...
    R.id = R.name = R.coords = function(a, b, c) {
        var d;
        if (!c)
    ...
    var Hc = /^(?:input|select|textarea|button|object)$/i
      , Ic = /^(?:a|area)$/i;
    d.fn.extend({
        prop: function(a, b) {
            return ca(this, d.prop, a, b, 1 < arguments.length)
        },
    ...
    d.fn.extend({
        addClass: function(a) {
            ...
            if (b)
                for (b = (a || "").match(N) || []; h < k; h++)
                    if (c = this[h],
                    e = 1 === c.nodeType && (c.className ? (" " + c.className + " ").replace(Wa, " ") : " ")) {
                        for (g = 0; f = b[g++]; )
                            0 > e.indexOf(" " + f + " ") && (e += f + " ");
                        e = d.trim(e);
        ...
        toggleClass: function(a, b) {
            ...
            return "boolean" === typeof b && "string" === c ? b ? this.addClass(a) : this.removeClass(a) : d.isFunction(a) ? this.each(function(c) {
                ...
                if ("string" === c)
                    for (var b, f = 0, g = d(this), h = a.match(N) || []; b = h[f++]; )
                    ...
                    this.className = this.className || !1 === a ? "" : d._data(this, "__className__") || ""
            })
        },
        hasClass: function(a) {
            a = " " + a + " ";
            for (var b = 0, c = this.length; b < c; b++)
                if (1 === this[b].nodeType && 0 <= (" " + this[b].className + " ").replace(Wa, " ").indexOf(a))
                    return !0;
            return !1
        }
    });
    ...
    d.parseJSON = function(a) {
        ...
        return e && !d.trim(e.replace(Jc, function(a, d, e, k) {
            b && d && (c = 0);
            if (0 === c)
                return a;
            b = e || d;
    ...
    ;
    var E, O, Kc = /#.*$/, Tb = /([?&])_=[^&]*/, Lc = /^(.*?):[ \t]*([^\r\n]*)\r?$/mg, Mc = /^(?:GET|HEAD)$/, Nc = /^\/\//, Ub = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, Vb = {}, Ka = {}, Wb = "*/".concat("*");
    try {
        O = location.href
    } catch (a) {
        O = n.createElement("a"),
    ...
    d.extend({
        ...
        ajaxSetup: function(a, b) {
            return b ? La(La(a, d.ajaxSettings), b) : La(d.ajaxSettings, a)
        },
        ajaxPrefilter: yb(Vb),
        ajaxTransport: yb(Ka),
        ajax: function(a, b) {
            function c(a, b, c, e) {
                ...
                if (2 !== K) {
                    ...
                    if (c) {
                        u = m;
                        for (var J = t, B, L, G, w, D = u.contents, E = u.dataTypes; "*" === E[0]; )
                            E.shift(),
                            void 0 === L && (L = u.mimeType || J.getResponseHeader("Content-Type"));
                        if (L)
                            for (w in D)
                                if (D[w] && D[w].test(L)) {
                                    E.unshift(w);
                    ...
                    a: {
                        ...
                        L = t;
                        G = e;
                        var I, x, H, J = {}, D = c.dataTypes.slice();
                        if (D[1])
                            for (x in c.converters)
                                J[x.toLowerCase()] = c.converters[x];
                        for (w = D.shift(); w; )
                            if (c.responseFields[w] && (L[c.responseFields[w]] = B),
                            !H && G && c.dataFilter && (B = c.dataFilter(B, c.dataType)),
                            H = w,
                            w = D.shift())
                                if ("*" === w)
                                    w = H;
                                    ...
                                    if (!x)
                                        for (I in J)
                                            if (u = I.split(" "),
                                            u[1] === w && (x = J[H + " " + u[0]] || J["* " + u[0]])) {
                                                !0 === x ? x = J[I] : !0 !== J[I] && (w = u[0],
                                                D.unshift(u[1]));
                                                break
                                            }
                                    if (!0 !== x)
                                        if (x && c["throws"])
                                            ...
                                            try {
                                                ...
                                                u = {
                                                    state: "parsererror",
                                                    error: x ? M : "No conversion from " + H + " to " + w
                                                };
                                                break a
                                            }
                                }
                    ...
                    if (e)
                        m.ifModified && ((v = t.getResponseHeader("Last-Modified")) && (d.lastModified[g] = v),
                        (v = t.getResponseHeader("etag")) && (d.etag[g] = v)),
                        204 === a || "HEAD" === m.type ? v = "nocontent" : 304 === a ? v = "notmodified" : (v = u.state,
                        f = u.data,
                        p = u.error,
                        e = !p);
                    else if (p = v,
                    ...
                    t.status = a;
                    t.statusText = (b || v) + "";
                    e ? y.resolveWith(q, [f, v, t]) : y.rejectWith(q, [t, v, p]);
                    t.statusCode(C);
                    C = void 0;
                    l && z.trigger(e ? "ajaxSuccess" : "ajaxError", [t, m, e ? f : p]);
                    F.fireWith(q, [t, v]);
                    l && (z.trigger("ajaxComplete", [t, m]),
            ...
            a = void 0);
            b = b || {};
            var e, f, g, h, k, l, n, p, m = d.ajaxSetup({}, b), q = m.context || m, z = m.context && (q.nodeType || q.jquery) ? d(q) : d.event, y = d.Deferred(), F = d.Callbacks("once memory"), C = m.statusCode || {}, D = {}, I = {}, K = 0, v = "canceled", t = {
                readyState: 0,
            ...
            y.promise(t).complete = F.add;
            t.success = t.done;
            t.error = t.fail;
            m.url = ((a || m.url || O) + "").replace(Kc, "").replace(Nc, E[1] + "//");
            m.type = b.method || b.type || m.method || m.type;
            m.dataTypes = d.trim(m.dataType || "*").toLowerCase().match(N) || [""];
            null == m.crossDomain && (e = Ub.exec(m.url.toLowerCase()),
            m.crossDomain = !(!e || e[1] === E[1] && e[2] === E[2] && (e[3] || ("http:" === e[1] ? "80" : "443")) === (E[3] || ("http:" === E[1] ? "80" : "443"))));
            ...
            g = m.url;
            m.hasContent || (m.data && (g = m.url += (Ya.test(g) ? "&" : "?") + m.data,
            delete m.data),
            !1 === m.cache && (m.url = Tb.test(g) ? g.replace(Tb, "$1_=" + Xa++) : g + (Ya.test(g) ? "&" : "?") + "_=" + Xa++));
            m.ifModified && (d.lastModified[g] && t.setRequestHeader("If-Modified-Since", d.lastModified[g]),
            d.etag[g] && t.setRequestHeader("If-None-Match", d.etag[g]));
            (m.data && m.hasContent && !1 !== m.contentType || b.contentType) && t.setRequestHeader("Content-Type", m.contentType);
            t.setRequestHeader("Accept", m.dataTypes[0] && m.accepts[m.dataTypes[0]] ? m.accepts[m.dataTypes[0]] + ("*" !== m.dataTypes[0] ? ", " + Wb + "; q=0.01" : "") : m.accepts["*"]);
            for (f in m.headers)
                t.setRequestHeader(f, m.headers[f]);
            if (m.beforeSend && (!1 === m.beforeSend.call(q, t, m) || 2 === K))
                return t.abort();
            v = "abort";
            for (f in {
                success: 1,
    ...
    d.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var a = this.type;
                return this.name && !d(this).is(":disabled") && Qc.test(this.nodeName) && !Pc.test(a) && (this.checked || !Ia.test(a))
            }).map(function(a, b) {
                var c = d(this).val();
    ...
    d.ajaxSettings.xhr = void 0 !== q.ActiveXObject ? function() {
        var a;
        if (!(a = !this.isLocal && /^(get|post|head|put|delete|options)$/i.test(this.type) && Ab()))
            a: {
                try {
    ...
    p.cors = !!Ea && "withCredentials"in Ea;
    (Ea = p.ajax = !!Ea) && d.ajaxTransport(function(a) {
        if (!a.crossDomain || p.cors) {
            ...
            return {
                send: function(c, e) {
                    ...
                    for (f in c)
                        void 0 !== c[f] && g.setRequestHeader(f, c[f] + "");
                    ...
                    ;
                    a.async ? 4 === g.readyState ? setTimeout(b) : g.onreadystatechange = Da[h] = b : b()
                },
                abort: function() {
                    b && b(void 0, !0)
                }
    ...
    d.ajaxSetup({
        ...
        jsonpCallback: function() {
            var a = Yb.pop() || d.expando + "_" + Xa++;
            this[a] = !0;
            return a
        }
    });
    d.ajaxPrefilter("json jsonp", function(a, b, c) {
        var e, f, g, h = !1 !== a.jsonp && (Za.test(a.url) ? "url" : "string" === typeof a.data && !(a.contentType || "").indexOf("application/x-www-form-urlencoded") && Za.test(a.data) && "data");
        if (h || "jsonp" === a.dataTypes[0])
            return e = a.jsonpCallback = d.isFunction(a.jsonpCallback) ? a.jsonpCallback() : a.jsonpCallback,
            h ? a[h] = a[h].replace(Za, "$1" + e) : !1 !== a.jsonp && (a.url += (Ya.test(a.url) ? "&" : "?") + a.jsonp + "=" + e),
    ...
    d.fn.load = function(a, b, c) {
        ...
        0 <= k && (e = d.trim(a.slice(k, a.length)),
        a = a.slice(0, k));
        d.isFunction(b) ? (c = b,
    ...
    d.offset = {
        setOffset: function(a, b, c) {
            ...
            f = d.css(a, "top");
            e = d.css(a, "left");
            ("absolute" === h || "fixed" === h) && -1 < d.inArray("auto", [f, e]) ? (e = k.position(),
            f = e.top,
    ...
    d.fn.extend({
        ...
        position: function() {
            if (this[0]) {
                ...
                "fixed" === d.css(e, "position") ? b = e.getBoundingClientRect() : (a = this.offsetParent(),
                b = this.offset(),
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var a = this.offsetParent || $b; a && !d.nodeName(a, "html") && "static" === d.css(a, "position"); )
                    a = a.offsetParent;
                return a || $b
            })
        }
    ...
    d.each(["top", "left"], function(a, b) {
        d.cssHooks[b] = ob(p.pixelPosition, function(a, e) {
            if (e)
                return e = Y(a, b),
                ra.test(e) ? d(a).position()[b] + "px" : e
        })
    });
    d.each({
        Height: "height",
        ...
        d.each({
            ...
            d.fn[e] = function(e, g) {
                ...
                return ca(this, function(b, c, e) {
                    ...
                    Math.max(b.body["scroll" + a], c["scroll" + a], b.body["offset" + a], c["offset" + a], c["client" + a])) : void 0 === e ? d.css(b, c, k) : d.style(b, c, e, k)
                }, b, h ? e : void 0, h, null )
            }
        })
    });
    ...
    d.noConflict = function(a) {
        q.$ === d && (q.$ = Tc);
        a && q.jQuery === d && (q.jQuery = Sc);
        return d
    }
    ;
    "undefined" === typeof ha && (q.jQuery = q.$ = d);
    return d
});
